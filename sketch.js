...
var uButton, dButton, lButton, rButton;
...
function setup() {
  ...
  uButton = createButton("Arriba");
  uButton.position(windowWidth/2,windowHeight/2);
...
function draw() {
  ...
  fill("white");
  textSize(27);
  text("Puntuación: " + touches.length, width-200, 40);
